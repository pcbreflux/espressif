...
// Additions Copyright (C) Copyright 2017 pcbreflux
//
...
static void initialise_wifi(void)
{
    ...
    BLUFI_INFO("Setting WiFi configuration SSID %s (%s)...", wifi_config.sta.ssid, wifi_config.sta.password);
...
static void blufi_event_callback(esp_blufi_cb_event_t event, esp_blufi_cb_param_t *param)
{
    ...
    case ESP_BLUFI_EVENT_INIT_FINISH:
        BLUFI_INFO("BLUFI init finish 1\n");
        gap_init();
        break;
    case ESP_BLUFI_EVENT_DEINIT_FINISH:
        BLUFI_INFO("BLUFI deinit finish 2\n");
        break;
...
void app_main()
{
    ...
    if (ret) {
        BLUFI_ERROR("%s enable bluedroid failed\n", __func__);
        return;
    }
