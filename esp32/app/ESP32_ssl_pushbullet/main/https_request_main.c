...
*/
#define EXAMPLE_WIFI_SSID "ESPZONE"
#define EXAMPLE_WIFI_PASS "esp32example"
...
#define WEB_SERVER "api.pushbullet.com"
#define WEB_PORT "443"
#define PUSHBULLET_TOKEN "####paste your token here###"
    ...
    while(1) {
        ...
        */
        ...
        ESP_LOGI(TAG, "Writing HTTP request...");
		 ...
		 //sprintf(bodybuf,"{\"body\":\"Hello, from the ESP32\",\"title\":\"Message\",\"type\":\"note\"}");
