...
COMPONENT_LDFLAGS += -L $(IDF_PATH)/components/bootloader/src/main -lmain -T esp32.bootloader.ld -T $(IDF_PATH)/components/esp32/ld/esp32.rom.ld -T $(IDF_PATH)/components/esp32/ld/esp32.peripherals.ld -T esp32.bootloader.rom.ld -L $(IDF_PATH)/components/esp32/lib/ -lrtc_clk -lrtc
